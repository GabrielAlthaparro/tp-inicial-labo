...
image::entrega4/63eebf554563f71204a1fa66_architecture.png[]
...
----
4-Luego ejecutar paso 9 de la anterior sección y en vez de poner la iP ubicamos el link que nos proporciona Ngrok 
